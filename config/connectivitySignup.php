...
function facebookUser($fullname,$email) {
	...
	$query = mysql_query("SELECT * FROM users WHERE username = '$fullname' AND email = '$email'") or die(mysql_error());
	if (mysql_num_rows($query) <= 0) { 
		echo '###';
		$query1 = "INSERT INTO users (username,email,password,user_team) VALUES ('$fullname','$email','$password','0')";
